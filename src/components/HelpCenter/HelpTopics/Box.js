...
const Box = ({ Icon, title, list = [] }) => {
  ...
  return (
    <div className='w-full md:w-5/12 lg:w-1/3 px-3'>
      <div
        className={`border mb-2  px-7 py-5 rounded-lg hover:border-none hover:cursor-pointer hover:shadow-xl transition-shadow duration-500 ${classes.main} `}
      >
