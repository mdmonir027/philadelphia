  ...
  return (
    <div className='my-10'>
      <div className='custom-container'>
        <TripHeading isTitle={isTitle} setIsTitle={setIsTitle} />
        ...
        <p className='px-5 py-3 rounded-lg text-white font-bold bg-primary w-max text-center flex gap-3 items-center mt-8'>
          <FaSyncAlt />
          <span>Load More</span>
        </p>
      </div>
